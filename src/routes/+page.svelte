...
<Card.Root class="mx-2 my-4 max-w-2xl lg:mx-auto">
	<Card.Header>
		<Card.Title class="text-center text-2xl">DSN Converter</Card.Title>
	</Card.Header>
	<Card.Content>
		<Tabs.Root value="dialer">
			<Tabs.List class="w-full">
				<Tabs.Trigger value="dialer">Dial</Tabs.Trigger>
					...
					{#if base.length > 0}
						<div class="mt-4 flex gap-2">
							<Button
								...
								onclick={copy}
							>
								<monospace class="text-amber-500"
									>{base[0]} <span class="text-cyan-500">{base[1]}</span></monospace
								>
							</Button>
			...
			<Tabs.Content value="table"><DataTable data={index} {columns} /></Tabs.Content>
		</Tabs.Root>
	</Card.Content>
