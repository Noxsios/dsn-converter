...
<div class="mx-auto flex h-dvh w-full max-w-4xl flex-col gap-4 p-4">
	<div class="flex flex-1 flex-col">
		<Tabs.Root value="convert" class="w-full">
			...
			<Tabs.Content value="convert" class="flex-1">
				<div class="flex h-full flex-col items-center justify-center gap-4 sm:gap-8">
					<form>
						<p class="text-muted-foreground mb-4 py-2 text-center text-sm font-medium">
							Enter a 7-digit DSN number to dial
						</p>
						<div class="flex justify-center sm:scale-125">
							<InputOTP.Root
								maxlength={7}
								bind:value={query}
								pattern="[0-9]"
